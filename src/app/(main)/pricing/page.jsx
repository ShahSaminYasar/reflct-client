...
export default function PricingPage() {
  ...
  // Handle unauthenticated state (Private route requirement)
  if (!session || !session.user) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-background text-foreground px-4">
        <Card className="max-w-xs w-full text-center py-6 px-4 space-y-4 rounded-none border-muted">
          <CardHeader className="p-0 space-y-1">
            <div className="mx-auto bg-muted p-2 w-max rounded-none">
          ...
          <CardContent className="p-0">
            <Button
              ...
              className="w-full text-xs h-7 rounded-none bg-primary text-primary-foreground font-semibold"
            >
              Go to Login
            </Button>
          </CardContent>
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="text-center space-y-3 max-w-2xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground max-w-md mx-auto leading-relaxed">
            Unlock absolute access to comprehensive learning architecture, live
            creator toolsets, and high-priority learning resources built to
            excel.
          </p>
        </div>

        {/* Section 2: Conditional Pricing Card or Premium Member Success State */}
        <div className="max-w-md mx-auto">
          {isPremiumUser ? (
            ...
            >
              <Card className="rounded-2xl border-emerald-500/30 bg-emerald-500/5 shadow-xl shadow-emerald-500/5 relative overflow-hidden backdrop-blur-sm">
                ...
                <CardContent className="space-y-4 px-6 pb-8 text-center">
                  <div className="text-xs text-muted-foreground bg-emerald-500/10 text-emerald-700 dark:text-emerald-300 py-2 px-3 rounded-lg font-medium inline-block">
            ...
            <motion.div
              ...
              transition={{ duration: 0.4 }}
            >
              <Card className="rounded-2xl border-primary/20 bg-card shadow-2xl relative overflow-hidden flex flex-col justify-between">
